...
const transformChain = (uiMessage) => {
    ...
    const linkParser = uiMessage.provider === "vsls" || uiMessage.provider === "vslsCommunities" ? parseSimpleLinks : exports.parseSlackLinks;
    return Object.assign({}, uiMessage, { messages: exports.markdownify(linkParser(exports.emojify(messages))) });
};

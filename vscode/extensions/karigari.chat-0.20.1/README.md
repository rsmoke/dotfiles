...
<sup>1</sup> Discord support is experimental. Please see [this doc](https://github.com/vsls-contrib/chat/blob/master/docs/DISCORD.md) for more details.
...
3.  **For Discord**, configure your token with instructions [given here](https://github.com/vsls-contrib/chat/blob/master/docs/DISCORD.md)
...
- **New chat providers**: The implementation can be extended to support any chat provider, see [PROVIDERS](https://github.com/vsls-contrib/chat/blob/master/docs/PROVIDERS.md).

...
- Recent Color State vs Peacock Color Memento
  ...
  - Example:
    - Peacock may be using #fff and Peacock Remote is using [#000](https://github.com/johnpapa/vscode-peacock/issues/000).
    - When using remote, recent color may represent
    - the remote color [#000](https://github.com/johnpapa/vscode-peacock/issues/000) while the memento will always be the original #fff

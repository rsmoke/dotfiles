...
```text
Gatsby Purple -> [#123456](https://github.com/johnpapa/vscode-peacock/issues/123456)
Auth0 Orange -> #eb5424
Azure Blue -> #007fff
```
...
![Remote Integration with Peacock](https://github.com/johnpapa/vscode-peacock/raw/master/./resources/peacock-remote.gif)
...
1. Workspace colors are set to [#369](https://github.com/johnpapa/vscode-peacock/issues/369)
1. User goes to settings and unchecks the "Peacock: Affect StatusBar"
1. Peacock listens to this change, clears all colors and reapplies the [#369](https://github.com/johnpapa/vscode-peacock/issues/369)
